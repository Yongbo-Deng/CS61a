...
class TutorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        if player.hand:
            added =True
            player.hand += [Card(player.hand[0].name,player.hand[0].attack,player.hand[0].defense)]
        # You should add your implementation above this.
        if added:
    ...
    def effect(self, opponent_card, player, opponent, arg=None):
        ...
        if player.hand:
            ...
            for a in player.hand:
                if a.power(opponent_card)>best_card.power(opponent_card):
                    best_card=a
